...
class TriviaQaEvidenceCorpusTxt(object):
    ...
    def __init__(self, file_id_map=None):
        self.directory = join(CORPUS_DIR, "wiki_en/evidence")
...
def main():
    ...
    parse.add_argument("-o", "--output_dir", type=str, default=join(config.CORPUS_DIR, "wiki_en", "evidence"))
    parse.add_argument("-s", "--source", type=str, default=join(config.NEW_EN, "evidence"))
