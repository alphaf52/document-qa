...
from docqa.triviaqa.build_span_corpus import TriviaQaOpenDataset, TriviaQaWikiDataset, TriviaQaNewDataset
...
def main():
    ...
    parser.add_argument("corpus", choices=["web", "wiki", "web-open", "wiki_zh_ori", "wiki_en_trans_zh"])
